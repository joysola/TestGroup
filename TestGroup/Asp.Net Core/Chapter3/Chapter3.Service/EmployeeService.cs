...
namespace Service
{
    internal sealed class EmployeeService : IEmployeeService
    {
        ...
        public IEnumerable<EmployeeDto> GetEmployees(Guid companyId, bool trackChanges)
        {
            ...
            if (company is null)
                throw new CompanyNotFoundException(companyId); var employeesFromDb = _repository.Employee.GetEmployees(companyId, trackChanges);
        ...
        public async Task<(IEnumerable<ExpandoObject> employees, MetaData metaData)> GetEmployeesAsync(Guid companyId, EmployeeParameters employeeParameters, bool trackChanges)
        {
            ...
            return (employees: shapedData /*employeesDto*/, metaData: employeesWithMetaData.MetaData);
        }
